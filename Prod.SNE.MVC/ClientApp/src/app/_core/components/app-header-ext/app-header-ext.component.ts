...
@Component({
    selector: "app-header-ext",
    styles: [`
      .btn_hoverable:hover{cursor: pointer; }
    `],
    templateUrl: "./app-header-ext.component.html",styleUrls: ['./app-header-ext.component.css']
})
export class AppHeaderExtComponent implements OnInit {
  @Input() logo: string;
