...
import { AlertService, AuthService, ConfiguracionInicialResponse, 
  ConfiguracionInicialService, FileService, SisEnumeradoService, TIPO_ARCHIVO_ENUMERADO,TIPO_ENCUESTA } from "@app/_core";
...
export class GestionComponent implements OnInit {
  ...
  getConfiguracion_inicial(){
    ...
    this.configuracion_inicial_s.GetActualConfiguracion(TIPO_ENCUESTA.intranet).then(async datos => {
      if(datos.data){
