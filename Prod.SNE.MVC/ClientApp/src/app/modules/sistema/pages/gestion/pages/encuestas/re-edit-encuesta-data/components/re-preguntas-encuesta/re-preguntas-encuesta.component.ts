...
@Component({
  selector: 'app-re-preguntas-encuesta',
  templateUrl: './re-preguntas-encuesta.component.html',
  styleUrls: ['./re-preguntas-encuesta.component.css']
})
export class RePreguntasEncuestaComponent implements OnInit {
