...
@Component({
  selector: 'app-encuestados-encuesta',
  templateUrl: './encuestados-encuesta.component.html',
  styleUrls: ['./encuestados-encuesta.component.css']
})
export class EncuestadosEncuestaComponent implements OnInit {
  ...
  get_list=()=>{
    ...
    this.spinner.show();
    this.encuesta_s._GetEncuestadosByFilterEncuesta(filtro, this.pageIndex, 1000000)
      .then((datos) => {
        this.spinner.hide();
