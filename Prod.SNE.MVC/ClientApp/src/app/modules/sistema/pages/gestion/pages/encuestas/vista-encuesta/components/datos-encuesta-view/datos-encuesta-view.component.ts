...
import { EncuestaAgradecimientoData, EncuestaBienvenidaData, EncuestaData, EncuestaMainData,DecoupledInit, FILE_SETTINGS, TIPO_ARCHIVO_ENUMERADO, SIS_TIPO_ENUMERADO, SisEnumeradoService, EncuestasService, EncuestaSaveUpdateRequest, ESTADO_ENCUESTA_ENUMERADO } from '@app/_core';
...
@Component({
  selector: 'app-datos-encuesta-view',
  templateUrl: './datos-encuesta-view.component.html',
  styleUrls: ['./datos-encuesta-view.component.css']
})
export class DatosEncuestaViewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.show_file_agradecimiento=this.frm_greet_data.id_tipo_archivo==TIPO_ARCHIVO_ENUMERADO.imagen?true:false;
    this.show_url=this.frm_greet_data.id_tipo_archivo==TIPO_ARCHIVO_ENUMERADO.video?true:false;

    this.show_url_welcome=this.frm_welcome_data.id_tipo_archivo==TIPO_ARCHIVO_ENUMERADO.video?true:false;
    this.show_file_input_welcome=this.frm_welcome_data.id_tipo_archivo==TIPO_ARCHIVO_ENUMERADO.imagen?true:false;
  ...
  frm_welcome_data:EncuestaBienvenidaData={iden_imagen:null};
  frm_greet_data:EncuestaAgradecimientoData={iden_imagen:null};
