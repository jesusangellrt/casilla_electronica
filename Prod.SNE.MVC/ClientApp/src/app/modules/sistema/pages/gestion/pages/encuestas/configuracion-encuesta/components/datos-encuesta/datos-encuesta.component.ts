...
export class DatosEncuestaComponent implements OnInit {
  ...
  create_form(){
    this.formMACRO = this._formBuilder.group({
      ...
      Encabezado:  [null], //[null, Validators.required],
      ...
      TipoArchivoBienvenida:  [null],//[null,Validators.required],
      UrlMultimediaBienvenida: [null],

      IndicacionesAgradecimiento: [null, Validators.required],
      TipoArchivoAgradecimiento: [null],//[null,Validators.required],
  ...
  save_update(){
    ...
    if(allow){
      let input:EncuestaSaveUpdateRequest={
        ...
        tipo_encuesta: TIPO_ENCUESTA.intranet//tipo de encuesta Intranet
      };
      this.spinner.show();
