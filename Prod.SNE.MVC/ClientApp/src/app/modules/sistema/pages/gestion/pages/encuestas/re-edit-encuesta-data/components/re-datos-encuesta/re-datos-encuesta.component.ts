...
@Component({
  selector: 'app-re-datos-encuesta',
  templateUrl: './re-datos-encuesta.component.html',
  styleUrls: ['./re-datos-encuesta.component.css']
})
export class ReDatosEncuestaComponent implements OnInit {
