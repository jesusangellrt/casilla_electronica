...
@Component({
  selector: 'app-re-edit-encuesta-data',
  templateUrl: './re-edit-encuesta-data.component.html',
  styleUrls: ['./re-edit-encuesta-data.component.css']
})
export class ReEditEncuestaDataComponent implements OnInit {
  constructor(
  ...
  handlePublishSuccess=(is_publised:boolean)=>{
    if(is_publised){
      this.router.navigate(['/sistema/gestion/gestor-encuestas']);
    }
  }
