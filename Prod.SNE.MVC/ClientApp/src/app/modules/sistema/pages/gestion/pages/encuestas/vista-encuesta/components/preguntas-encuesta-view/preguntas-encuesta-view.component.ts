...
@Component({
  selector: 'app-preguntas-encuesta-view',
  templateUrl: './preguntas-encuesta-view.component.html',
  styleUrls: ['./preguntas-encuesta-view.component.css']
})
export class PreguntasEncuestaViewComponent implements OnInit {
