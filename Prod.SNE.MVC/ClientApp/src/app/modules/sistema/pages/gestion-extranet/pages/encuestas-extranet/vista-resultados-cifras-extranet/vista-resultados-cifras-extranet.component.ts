...
@Component({
  ...
  templateUrl: './vista-resultados-cifras-extranet.component.html',
  styleUrls: ['./vista-resultados-cifras-extranet.component.css']
})
export class VistaResultadosCifrasExtranetComponent implements OnInit {
