...
@Component({
  ...
  templateUrl: './encuestados-encuesta-extranet.component.html',
  styleUrls: ['./encuestados-encuesta-extranet.component.css']
})
export class EncuestadosEncuestaExtranetComponent implements OnInit {
