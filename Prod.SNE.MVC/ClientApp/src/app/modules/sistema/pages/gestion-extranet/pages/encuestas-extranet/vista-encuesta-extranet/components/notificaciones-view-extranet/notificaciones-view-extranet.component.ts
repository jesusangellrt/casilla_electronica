...
@Component({
  ...
  templateUrl: './notificaciones-view-extranet.component.html',
  styleUrls: ['./notificaciones-view-extranet.component.css']
})
export class NotificacionesViewExtranetComponent implements OnInit {
