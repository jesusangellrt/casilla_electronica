...
@Component({
  ...
  templateUrl: './modal-vista-pregunta-extranet.component.html',
  styleUrls: ['./modal-vista-pregunta-extranet.component.css']
})
export class ModalVistaPreguntaExtranetComponent implements OnInit {
