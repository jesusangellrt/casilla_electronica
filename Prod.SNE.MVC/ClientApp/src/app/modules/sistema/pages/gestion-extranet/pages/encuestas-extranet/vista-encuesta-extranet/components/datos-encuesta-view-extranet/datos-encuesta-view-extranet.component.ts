...
@Component({
  ...
  templateUrl: './datos-encuesta-view-extranet.component.html',
  styleUrls: ['./datos-encuesta-view-extranet.component.css']
})
export class DatosEncuestaViewExtranetComponent implements OnInit {
