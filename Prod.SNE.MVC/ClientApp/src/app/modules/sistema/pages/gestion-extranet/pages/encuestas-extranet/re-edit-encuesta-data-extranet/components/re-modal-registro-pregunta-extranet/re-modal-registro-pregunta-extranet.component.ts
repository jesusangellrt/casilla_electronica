...
@Component({
  ...
  templateUrl: './re-modal-registro-pregunta-extranet.component.html',
  styleUrls: ['./re-modal-registro-pregunta-extranet.component.css']
})
export class ReModalRegistroPreguntaExtranetComponent implements OnInit {
