...
@Component({
  ...
  templateUrl: './secciones-pregunta-extranet.component.html',
  styleUrls: ['./secciones-pregunta-extranet.component.css']
})
export class SeccionesPreguntaExtranetComponent implements OnInit {
