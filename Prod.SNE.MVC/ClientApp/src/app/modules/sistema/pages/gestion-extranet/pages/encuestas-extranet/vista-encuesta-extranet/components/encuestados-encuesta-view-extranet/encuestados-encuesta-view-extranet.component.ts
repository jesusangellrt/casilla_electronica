...
@Component({
  ...
  templateUrl: './encuestados-encuesta-view-extranet.component.html',
  styleUrls: ['./encuestados-encuesta-view-extranet.component.css']
})
export class EncuestadosEncuestaViewExtranetComponent implements  OnInit {
