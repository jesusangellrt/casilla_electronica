...
@Component({
  ...
  templateUrl: './llenado-pregunta-ext.component.html',
  styleUrls: ['./llenado-pregunta-ext.component.css']
})
export class LlenadoPreguntaExtComponent implements OnInit {
  ...
  async ngOnInit() {  
    ...
    setTimeout(()=>{
      ...
      if(!this.es_anonima){
        this.spinner.show();
        this.respuesta_s._GetRespuestasByEncuestaAndEncuestado(this.id_encuesta, TIPO_ENCUESTA.extranet)
        .then((datos) => {
  ...
  getPreguntasEncuesta=(show_spinner=true)=>{
